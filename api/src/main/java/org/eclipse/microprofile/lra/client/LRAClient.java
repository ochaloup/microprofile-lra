...
public interface LRAClient {
    ...
    /**
     * the name of the HTTP header field that contains a recovery URL corresponding to a participant
    ...
    /**
     * Start a top level LRA (ie similar to {@link LRAClient#startLRA(URL, String, Long, TimeUnit)}
     */
     ...
     *               to drive the participant. By convention, the coordinator will use the URL
     *               as follows:
     *
