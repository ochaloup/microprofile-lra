...
public class TckCancelOnTests extends TckTestBase {
    ...
    public void cancelFromRemoteCall() {
        ...
        lraMetric.assertNotCompensated("Status was 200 but compensate should be called as LRA should be cancelled for remotely called participant as well",
                lraId, LraCancelOnResource.class);
        lraMetric.assertCompleted("Even the 200 status was received the remotely called participant should cause the LRA being cancelled",
                lraId, LraCancelOnResource.class);
    }
}
